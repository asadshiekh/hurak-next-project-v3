...
const UsersReceipt = () => {
    ...
    const MrOptions = [
        { text: ' select', value: ' Small (1-10 employees)' },
        { text: ' Partial refund', value: ' Small (1-10 employees)' },
        { text: ' full refund', value: ' Small (1-10 employees)' }
    ];
    ...
    return (
        <div>
            <Header headerText={'Receipt'} breadcrum={'Purchase history / Receipt'} />
            <div ref={contentRef} className={activeClass}>
                ...
                <div className={receiptActiveClass}>
                    ...
                    {isButtonVisible && (
                        <div>
                            <ButtonFill handelClick={handleGeneratePdf} color={"primary"} text={"Download PDF"} />
                        </div>
                    )}
                </div>
                ...
                <div className={providerActiveClass}>
                    ...
                    {isButtonVisible && (
                        <div><ButtonFill color={"primary"} size={"xs"} text={"Request invoice"} /></div>
                ...
                <div className=' border relative overflow-x-auto'>
                    {isButtonVisible && (
                        <div className='absolute top-16 lg:right-[400px] right-[7px] md:right-[270px]'>
                    ...
                    <div className="bg-white p-6 pt-4 rounded shadow-lg max-w-xl w-full relative">
                        ...
                        <div>
                            <form>
                                ...
                                <textarea name="" id="" className='px-2 py-1 border w-full rounded outline-none focus:border-blue' rows={4}></textarea>
                            </form>
                        </div>
